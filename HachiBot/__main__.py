...
PM_START_TEXT = """
*炎 Goemon Hachisuka* Is Advance management group with extra anime-theme include the all features[!](https://telegra.ph/file/9e1017e310aa7b6551c52.jpg)
"""
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    ...
                    InlineKeyboardButton(text="Updates", url="https://t.me/HachiXLog"),
                 ],
                 [
                    InlineKeyboardButton(text="Go Back", callback_data="hachi_"),
