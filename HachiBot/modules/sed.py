...
import regex
import telegram
from HachiBot import LOGGER, dispatcher
from HachiBot.modules.disable import DisableAbleMessageHandler
from HachiBot.modules.helper_funcs.regex_helper import infinite_loop_check
...
SED_HANDLER = DisableAbleMessageHandler(
    Filters.regex(r"s([{}]).*?\1.*".format("".join(DELIMITERS))), sed, run_async=True, friendly="sed"
)
