...
@ddocmd(command=["sticid", "stickerid"])
...
@ddocmd(command=["getstic", "getstickers"])
...
@ddocmd(command=["delsticker", "delstic"])
...
× /stickerid or /sticid*:* reply to a sticker to me to tell you its file ID.
