...
if is_module_loaded(FILENAME):
    ...
    def disable(update: Update, context: CallbackContext):
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
        f"<u><b>disable CMDS Not Found</b></u>\n"
        f"Use /disable to disable command, like /disable afk",
    ...
    def disable_module(update: Update, context: CallbackContext):
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
        f"<u><b>Disable Modules Not Found</b></u>\n"
        f"Use /disablemodule to disable modules, like /disablemodule android",
        parse_mode=ParseMode.HTML,
        )
    ...
    def enable(update: Update, context: CallbackContext):
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
        f"<u><b>Enable CMDS Not Found</b></u>\n"
        f"Use /enable to enable command, like /enable afk",
        parse_mode=ParseMode.HTML,
        )
    ...
    def enable_module(update: Update, context: CallbackContext):
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
        f"<u><b>Enable Modules Not Found</b></u>\n"
        f"Use /enablemodule to enable modules, like /enablemodule android",
        parse_mode=ParseMode.HTML,
        )
