...
def export_data(update, context):
    ...
    with open("HachiRobot {}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("HachiRobot{}.backup".format(chat_id), "rb"),
    ...
    os.remove("HachiRobot{}.backup".format(chat_id))  # Cleaning file
