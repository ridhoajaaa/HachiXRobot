...
async def awake(event):
  PRIME = f"**Hi [{event.sender.first_name}](tg://user?id={event.sender.id}), I'm HachiXBot.** \n\n"
  ...
  BUTTON = [[Button.url("ʜᴇʟᴘ​", "https://t.me/HachiBotBot?start=help"), Button.url("sᴜᴘᴘᴏʀᴛ​", "https://t.me/demonszxx")]]
