...
from HachiBot import eor
from HachiBot import pgram as app
...
from HachiBot.utils.pastebin import hpaste, upload_text
...
@ddocmd(command="pvpaste", pass_args=True)
