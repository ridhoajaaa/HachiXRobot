...
from HachiBot.modules.sql.locales_sql import switch_to_locale, prev_locale
from HachiBot.modules.tr_engine.list_locale import list_locales
from HachiBot.modules.tr_engine.strings import tld, LANGUAGES
