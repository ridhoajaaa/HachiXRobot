...
from HachiBot.ex_plugins.dbfunctions import get_couple, save_couple
...
async def couple(_, message):
    ...
    try:
        ...
        if not is_selected:
            ...
            while c1_id == c2_id:
                c1_id = random.choice(list_of_users)
            c1_mention = (app.get_users(c1_id)).mention
            c2_mention = (app.get_users(c2_id)).mention

            couple_selection_message = f"""**Couple of the day:**
{c1_mention} + {c2_mention} = ❤️
__New couple of the day may be chosen at 12AM {tomorrow}__"""
            app.send_message(message.chat.id, text=couple_selection_message)
            ...
            c1_name = (app.get_users(c1_id)).first_name
            c2_name = (app.get_users(c2_id)).first_name
            couple_selection_message = f"""Couple of the day:
