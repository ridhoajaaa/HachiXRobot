...
from HachiBot import RSS_DELAY, pbot
from HachiBot.utils.errors import capture_err
from HachiBot.ex_plugins.dbfunctions import (add_rss_feed, get_rss_feeds, is_rss_active,
                                   remove_rss_feed, update_rss_feed)
from HachiBot.utils.functions import get_http_status_code, get_urls_from_text
from HachiBot.utils.rss import Feed
...
@pbot.on_message(filters.command("add_feed"))
@capture_err
...
@pbot.on_message(filters.command("rm_feed"))
