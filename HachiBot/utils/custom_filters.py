...
# Copyright (C) 2021 @szHachiBotbot

# This file is part of @szHachiBotbot (Telegram Bot)
...
from HachiBot import BOT_ID
from HachiBot.modules.sql.disable_sql import DISABLED
from HachiBot.modules.helper_funcs.chat_status import ADMIN_CACHE, admin_cache_reload
    ...
    async def func(flt, _, m: Message):
        ...
        if matches:
            ...
            if m.chat.type == "supergroup":
                try:
                    DISABLED_list = DISABLED[m.chat.id].get("commands", [])
                ...
                try:
                    ...
                    # i.e. PM
                    user_status = "creator"
                if str(matches.group(1)) in DISABLED_list and user_status not in (
                    "creator",
                    "administrator",
                ):
                    try:
